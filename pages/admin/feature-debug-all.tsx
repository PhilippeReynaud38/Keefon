// -*- coding: utf-8 -*-
// File: /pages/admin/feature-debug-all.tsx — Vivaya (legacy désactivé) 
//      FICHIER NEUTRALISE                  FICHIER NEUTRALISE                                   FICHIER NEUTRALISE
import Link from "next/link";   

export default function FeatureDebugAll() {
  const pageBg = "#1c1b1a";
  const cardBg = "#f3f1ec";
  const border = "#ded9cf";
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: pageBg, padding: 24 }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: 16, backgroundColor: "#2a2928", borderRadius: 12, border: `1px solid ${border}`, color: "#f5f5f5" }}>
        ...
        <h1 style={{ margin: 0, marginBottom: 12 }}>Admin · Feature Debug (global) — désactivé</h1>
        <div style={{ background: cardBg, border: `1px solid ${border}`, borderRadius: 10, padding: 16, color: "#1c1b1a" }}>
          ...
          <p style={{ margin: 0, lineHeight: 1.5 }}>
            Ce module n’est plus disponible depuis le retrait des cohortes/overrides.
          </p>
        </div>
      </div>
    </div>
