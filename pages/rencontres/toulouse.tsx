...
const SEO = {
  title: "Site de rencontres bienveillantes et gratuit à Toulouse",
  description:
    " échanges respectueux, sans swipe toxique. Chat ouvert pendant la période gratuite.",
  ...
  keywords: [
    ...
    "site de rencontres bienveillantes",
  ].join(", "),
  breadcrumb: [
