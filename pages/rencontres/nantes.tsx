...
const SEO = {
  title: "Site de rencontres bienveillantes et gratuit à Nantes",
  description:
    "Site de rencontre à Nantes et autour (Rezé, Saint-Herblain, Orvault, Vertou…) : échanges respectueux, sans swipe toxique, gratuit toute l'année 2026.",
...
/* ===========================  Bandeau “exemples de profils” — Nantes  =========================== */
function ProfileTeaserBand() {
  /**
   * ⚠️ Fichiers à placer dans : /public/avatars_France/Nantes/
   * IMPORTANT :
   *  - pas d’accents ni d’espaces dans les noms de fichiers (Fred.png, Nathalie.png,
   *    Claire.png, Eric.png par exemple)
   *  - tu peux renommer les images côté disque, le chemin doit suivre ces valeurs.
   */
  const profiles = [
    {
      pseudo: "Fred",
      ageVille: "28 ans — Nantes centre",
      badges: ["Free"],
      phrase:
        "Je bosse en centre-ville et je profite des quais et des machines de l’île dès que je peux. J'aime beaucoup Keefon, pour sa facilité de rencontrer d'autres personnes.",
      avatarSrc: "/avatars_France/Nantes/Fred.png",
      avatarAlt:
        "Profil fictif Fred (jeune homme souriant près d’un port ou d’un quai)",
      priority: true,
    },
    {
      pseudo: "Nathalie",
      ageVille: "27 ans — Nantes",
      badges: ["Essentiel"],
      phrase:
        "Entre le boulot, le tram et les sorties avec les amis, je n’ai pas envie de passer mes soirées à swiper. Je préfère quelques échanges humains et clairs.",
      avatarSrc: "/avatars_France/Nantes/Nathalie.png",
      avatarAlt:
        "Profil fictif Nathalie (jeune femme souriante dans une avenue avec palmiers ou arbres)",
      priority: true,
    },
    {
      pseudo: "Claire",
      ageVille: "43 ans — bords de Loire",
      badges: ["Free"],
      phrase:
        "Je partage mon temps entre la ville, les cafés et les balades le long de l’Erdre. Sur Keefon, je rencontre des personnes intéressantes.",
      avatarSrc: "/avatars_France/Nantes/Claire.png",
      avatarAlt:
        "Profil fictif Claire (femme souriante dans une rue avec façades en briques)",
    },
    {
      pseudo: "Eric",
      ageVille: "51 ans — métropole nantaise",
      badges: ["Essentiel"],
      phrase:
        "Je bouge beaucoup pour le travail entre Nantes et l’océan. Keefon m’aide à garder des échanges simples, j'aime beaucoup ce site.",
      avatarSrc: "/avatars_France/Nantes/Eric.png",
      avatarAlt:
        "Profil fictif Eric (homme souriant près d’un port ou d’un plan d’eau)",
    },
  ];
...
/* ===========================  Page  =========================== */
export default function NantesRencontresPage() {
  const jsonLd = {
  ...
  return (
    <>
      ...
      <main
         ...
         *  - tu pourras remplacer plus tard par un visuel type “bg-Nantes-ext.png”
...
>
  Déjà inscrit ? Se connecter
        ...
        <section className="py-10">
          <div className="container mx-auto max-w-5xl px-4">
            <h2 className="text-xl font-semibold text-menuBtn sm:text-2xl">
              Pourquoi Keefon est différent à Nantes&nbsp;?
            </h2>
            <div className="mt-6 max-w-3xl rounded-2xl border border-sky-200 bg-white/40 px-4 py-4 text-slate-900 shadow-sm backdrop-blur-[1px]">
              ...
              <p className="text-sm leading-relaxed">
                ...
                budget, même quand la vie quotidienne coûte déjà cher.
              </p>
            </div>
          </div>
        </section>

        {/* Nantes ancrée dans le réel */}
        <section className="py-10">
          <div className="container mx-auto max-w-5xl px-4">
            <h2 className="text-xl font-semibold text-menuBtn sm:text-2xl">
              Rencontrer à Nantes, sans se perdre dans la masse
            </h2>
            <p className="mt-3 text-sm leading-relaxed text-slate-900 sm:text-base">
              Une grande ville, des trams, beaucoup de quartiers, les bords de
              Loire et de l’Erdre. Keefon te permet d&apos;ouvrir des portes
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              <article className="rounded-2xl border border-sky-200 bg-white/40 px-4 py-4 text-slate-900 shadow-sm backdrop-blur-[1px]">
                <h3 className="mb-2 text-sm font-semibold text-chatOuter sm:text-base">
                  Centre-ville, île de Nantes, quartiers…
                </h3>
                <p className="text-sm leading-relaxed">
                  Que tu vives près du château, sur l’île de Nantes, à
                  Doulon-Bottière ou plus loin, tu peux croiser des personnes
                  qui partagent la même ville et la même énergie que toi.
                </p>
              </article>

              <article className="rounded-2xl border border-sky-200 bg-white/40 px-4 py-4 text-slate-900 shadow-sm backdrop-blur-[1px]">
                <h3 className="mb-2 text-sm font-semibold text-chatOuter sm:text-base">
                  Et le reste de la Loire-Atlantique si tu bouges
                </h3>
                <p className="text-sm leading-relaxed">
                  Si tu te déplaces souvent vers Rezé, Saint-Herblain,
                  Pornichet, la côte ou l&apos;intérieur, tu peux aussi
        ...
        {/* Idées de sorties locales (Nantes & alentours) */}
          ...
          <div className="mx-auto max-w-5xl px-4">
            <div className="rounded-2xl bg-white/30 px-4 py-3 text-[11px] text-slate-900 shadow-sm backdrop-blur-[2px]">
              <h2 className="mb-1 text-xs font-semibold text-chatOuter">
                Quelques idées de sorties autour de Nantes
              </h2>
              <ul className="list-disc space-y-1 pl-4">
                <li>
                  Balade en centre-ville entre la place Royale, le passage
                  Pommeraye et le château, avec un café en terrasse pour
                  discuter tranquillement.
                </li>
                <li>
                  Promenade sur l’île de Nantes, autour des Machines et des
                  quais, en choisissant un point de rendez-vous public simple à
                  retrouver.
                </li>
                <li>
                  Marche le long de l’Erdre ou vers un parc comme le parc de
                  Procé, pour parler dans un cadre un peu plus calme et vert.
                </li>
                <li>
                  Traversée en Navibus vers Trentemoult ou sortie dans un
                  quartier animé, si vous avez envie d’un endroit un peu à part
                  mais facilement accessible.
                </li>
                <li>
                  Si vous aimez bouger, petite escapade vers la côte ou un
                  village de Loire-Atlantique, en gardant un cadre simple,
                  public et sécurisé.
                </li>
              </ul>
              <p className="mt-2">
