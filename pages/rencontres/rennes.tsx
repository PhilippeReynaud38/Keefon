...
/* ===========================  SEO (Rennes / Bretagne)  =========================== */
const SEO = {
  title: " Site de rencontres bienveillantes et gratuit à Rennes ",
  description:
    "Rencontre à Rennes et autour (Cesson-Sévigné, Saint-Grégoire, Chantepie, Bruz…) : échanges respectueux, sans swipe toxique. Chat gratuit j'usqu'à fin 2026.",
  canonical: "https://www.keefon.com/rencontres/rennes",
  siteName: "Keefon",
  ogImage: "https://www.keefon.com/og/rencontres-Rennes.jpg",
  keywords: [
    "site de rencontre gratuit à rennes",
