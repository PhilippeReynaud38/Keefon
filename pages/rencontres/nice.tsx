...
const SEO = {
  title: " Site de rencontres bienveillantes et gratuit à Nice",
  description:
    "Rencontre à Nice et autour (Cagnes-sur-Mer, Saint-Laurent-du-Var, Villefranche, Antibes…) : échanges respectueux, sans swipe toxique. gratuit pendant la période de lancement.",
  canonical: "https://www.keefon.com/rencontres/nice",
  siteName: "Keefon",
  ogImage: "https://www.keefon.com/og/rencontres-Nice.jpg",
  keywords: [
    "site de rencontre nice",
    "site rencontre sans swipe",
    "site rencontres bienveillantes",
  ].join(", "),
  breadcrumb: [
