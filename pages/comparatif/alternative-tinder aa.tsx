...
const SEO = {
  title: "Alternative à Tinder : Keefon, rencontre sans swipe",
  description:
    "Vous cherchez une alternative à Tinder ? Découvrez Keefon : une plateforme indépendante de rencontres sans swipe, pensée pour des échanges plus humains, clairs et respectueux.",
...
export default function AlternativeTinderPage() {
  const faq = [
    {
      q: "Keefon est-il affilié à Tinder ?",
      a: "Non. Keefon est une plateforme indépendante et ne revendique aucune association avec Tinder."
    },
    {
      q: "Qu’est-ce que “sans swipe” veut dire ?",
      a: "Au lieu de faire défiler des profils à l’infini, l’expérience est pensée pour favoriser l’échange : moins de tri rapide, plus de discussion."
    },
    {
      q: "Keefon est-il gratuit ?",
      a: "Oui pendant la période d’ouverture : l’accès est gratuit jusqu’à fin 2026 pour les 2 000 premiers inscrits (selon conditions)."
    },
    {
      q: "Puis-je utiliser Keefon sans abonnement ?",
      a: "Oui. L’idée est de permettre des rencontres et des échanges même sans engagement. Un abonnement, s’il est proposé, reste abordable."
    },
  ];
      ...
      <main className="min-h-screen bg-gradient-to-b from-sky-100 via-sky-50 to-sky-100">
        <div className="mx-auto max-w-5xl px-4 py-10">
          ...
          <nav className="text-[12px] text-slate-600 mb-4">
            ...
            <span className="text-slate-800">Alternative à Tinder</span>
          </nav>
          ...
          <header className="rounded-3xl border border-sky-200/60 bg-slate-50/60/70 p-6 sm:p-10 shadow-sm">
            ...
            <p className="mt-4 text-base sm:text-lg text-slate-700 leading-relaxed max-w-3xl">
              Si vous cherchez une alternative à Tinder, c’est souvent pour une raison simple : vous voulez rencontrer des gens, mais sans le stress du “swipe” en continu. Keefon propose une expérience sans swipe, plus posée, avec une navigation claire et une modération simple.
            </p>
          ...
          <section className="mt-10">
            ...
            <div className="py-4 border-t border-slate-200/60">
              ...
              <div className="mt-3 grid grid-cols-2 gap-x-4 text-[13px] leading-relaxed">
                <div className="text-slate-900">Sans swipe (on parle d’abord, on choisit mieux)</div>
                <div className="text-slate-700 text-right">Souvent basé sur le swipe</div>
              </div>
            </div>
            <div className="py-4 border-t border-slate-200/60">
              <div className="flex justify-center">
              ...
              <div className="mt-3 grid grid-cols-2 gap-x-4 text-[13px] leading-relaxed">
                ...
                <div className="text-slate-700 text-right">Rythme souvent plus rapide</div>
              </div>
            </div>
            <div className="py-4 border-t border-slate-200/60">
              <div className="flex justify-center">
          ...
          <section className="mt-10 rounded-3xl border border-sky-200/60 bg-white/70 p-6 sm:p-10">
            ...
            <ul className="mt-4 list-disc pl-6 text-slate-700 space-y-2">
              <li>Le swipe en boucle fatigue : vous voulez plus de conversations, moins de décisions instantanées.</li>
              <li>Envie d’un espace plus humain (tous âges), où l’on prend le temps de parler et de se respecter.</li>
              <li>Besoin d’un cadre clair : favoris, échanges, profils… on s’y retrouve vite.</li>
              <li>Vous voulez garder la main sur ce que vous voyez (tri / filtres / modération).</li>
            </ul>
